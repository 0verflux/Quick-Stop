...
namespace QuickStop.Components.Helpers
{
    ...
    {
        /// <summary>
        /// Calculates the Total Cost of a <see cref="Domain.Models.HotelBook"/>.
        /// </summary>
        ...
        public static decimal CalculateTotalCost(decimal hotelPrice, int guestCount, int minGuestCount, int maxGuestCount, DateTime checkIn, DateTime checkOut)
        {
